...
export function DropdownManager() {
  const [activeCategory, setActiveCategory] = useState<keyof typeof tableNames>("cakeTypes");
      ...
      <CardContent>
        <div className="w-full">
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
            <Button 
              onClick={() => setActiveCategory("cakeTypes")}
              variant={activeCategory === "cakeTypes" ? "default" : "outline"}
              className={`${activeCategory === "cakeTypes" 
            ...
            <Button 
              ...
              variant={activeCategory === "bases" ? "default" : "outline"}
              className={`${activeCategory === "bases" 
            ...
            <Button 
              onClick={() => setActiveCategory("fillings")}
              variant={activeCategory === "fillings" ? "default" : "outline"}
              className={`${activeCategory === "fillings" 
            ...
            <Button 
              ...
              variant={activeCategory === "exteriors" ? "default" : "outline"}
              className={`${activeCategory === "exteriors" 
            ...
            <Button 
              ...
              variant={activeCategory === "decorations" ? "default" : "outline"}
              className={`${activeCategory === "decorations" 
